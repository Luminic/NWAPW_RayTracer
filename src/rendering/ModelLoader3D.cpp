...
Node* ModelLoader3D::load_model(const char* file_path) {
    ...
    for (unsigned int i = 0; i < scene->mNumMeshes; ++i) {
        ...
        Vertex vertices[MAX_VERTICES]; // mesh->mNumVertices
        ...
        Index indices[MAX_INDICES]; // mesh->mNumFaces * 3 /* 3 indices per triangle */
        ...
        // Form DynamicMesh
        meshes.push_back((new DynamicMesh<MAX_VERTICES, MAX_INDICES>(vertices, indices)));
    }
